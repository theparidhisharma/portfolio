      ...
      <div className="w-full h-full relative">
        ...
        <div
          className={`absolute inset-0 flex flex-col justify-end p-8 transition-opacity duration-500 ${
            hoveredGalleryItem === item.id ? "opacity-100" : "opacity-0"
          }`}
        >
          <span className="text-xs font-sans-ui font-bold uppercase tracking-widest text-blue-400 mb-2">
            {item.category}
          </span>
